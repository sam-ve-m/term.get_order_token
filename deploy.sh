fission spec init
fission env create --spec --name term-get-order-tkn-env --image nexus.sigame.com.br/fission-term-get-order-token:0.1.0-2 --poolsize 2 --graceperiod 3 --version 3 --imagepullsecret "nexus-v3" --spec
